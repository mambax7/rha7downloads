...
$adminmenu[1]['title'] = _MI_RHA7DOWNLOADS_ADMENU2;
$adminmenu[1]['link'] = "admin/index.php?op=downloadsConfigMenu";
$adminmenu[2]['title'] = _MI_RHA7DOWNLOADS_ADMENU3;
$adminmenu[2]['link'] = "admin/index.php?op=listNewDownloads";
$adminmenu[3]['title'] = _MI_RHA7DOWNLOADS_ADMENU4;
$adminmenu[3]['link'] = "admin/index.php?op=listBrokenDownloads";
$adminmenu[4]['title'] = _MI_RHA7DOWNLOADS_ADMENU5;
